...
function Hero() {
  return (
    <section className='relative min-h-screen bg-[#590018] flex items-center justify-between overflow-hidden'>
      ...
      <div className='relative z-10 text-center px-6 max-w-5xl mx-auto'>
        ...
        <a href="#projects" className='inline-flex items-center gap-2 mt-12 text-[#ffe4e4] text-sm tracking-widest uppercase border border-[#ffe4e4] px-8 py-4 hover:bg-[#f9eaea] hover:text-[#590018] transition-all duration-300'>Explore Projects</a>
      </div>
